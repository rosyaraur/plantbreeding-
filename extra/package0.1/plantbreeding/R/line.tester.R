line.tester <- function (dataframe, yvar,  genotypes = genotypes, replication,  Lines = Lines, Testers, gclass = gclass ){      dataframe <- data.frame (dataframe[,yvar], dataframe[,genotypes], dataframe [, replication], dataframe [,Lines], dataframe[,Testers], dataframe [,gclass])
